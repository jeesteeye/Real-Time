...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre
        class="prettyprint lang-js">var url    = require('url'),
...
<span class="cstat-no" title="statement not covered">    if ((options.hostRewrite || options.autoRewrite || options.protocolRewrite)</span>
      ...
      var target = <span class="cstat-no"
                         title="statement not covered">url.parse(options.target);</span>
...
<span class="cstat-no"
      title="statement not covered">        u.protocol = options.protocolRewrite;</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered">          if (header == undefined) <span
...
<span class="cstat-no" title="statement not covered">      for (var i = 0; i &lt; proxyRes.rawHeaders.length; i += 2) {</span>
        var key = <span class="cstat-no"
                        title="statement not covered">proxyRes.rawHeaders[i];</span>
<span class="cstat-no" title="statement not covered">        rawHeaderKeyMap[key.toLowerCase()] = key;</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered">    Object.keys(proxyRes.headers).forEach(<span
        class="fstat-no" title="function not covered">fu</span>nction(key) {</span>
      var header = <span class="cstat-no"
                         title="statement not covered">proxyRes.headers[key];</span>
<span class="cstat-no" title="statement not covered">      if (preserveHeaderKeyCase &amp;&amp; rawHeaderKeyMap) {</span>
<span class="cstat-no"
      title="statement not covered">        key = rawHeaderKeyMap[key] || key;</span>
      }
...
&nbsp;
   ...
   * @api private
   */
  writeStatusCode: function <span class="fstat-no"
                                  title="function not covered">writeStatusCode(</span>req, res, proxyRes) {
...
<span class="cstat-no"
      title="statement not covered">      res.writeHead(proxyRes.statusCode);</span>
    }
  }
&nbsp;
};
