...
<div class='wrapper'>
    <div class='pad1'>
        <h1>
            <a href="../../index.html">All files</a> / <a href="index.html">http-proxy/passes</a>
            web-incoming.js
        </h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre
        class="prettyprint lang-js">var httpNative   = require('http'),
    httpsNative  = require('https'),
    web_o  = require('./web-outgoing'),
    common = require('../common'),
    followRedirects = require('follow-redirects');
&nbsp;
<span class="cstat-no" title="statement not covered">web_o = Object.keys(web_o).map(<span
        class="fstat-no" title="function not covered">fu</span>nction(pass) {</span>
...
<span class="cstat-no"
      title="statement not covered">      req.headers['content-length'] = '0';</span>
<span class="cstat-no"
      title="statement not covered">      delete req.headers['transfer-encoding'];</span>
    }
  },
&nbsp;
  /**
...
<span class="cstat-no"
      title="statement not covered">      req.socket.setTimeout(options.timeout);</span>
    }
  },
&nbsp;
  /**
...
<span class="cstat-no"
      title="statement not covered">      forwardReq.on('error', forwardError);</span>
&nbsp;
<span class="cstat-no"
      title="statement not covered">      (options.buffer || req).pipe(forwardReq);</span>
<span class="cstat-no" title="statement not covered">      if(!options.target) { <span
        class="cstat-no" title="statement not covered">return res.end(); </span>}</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered">    proxyReq.on('socket', <span
        class="fstat-no" title="function not covered">fu</span>nction(socket) {</span>
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">    (options.buffer || req).pipe(proxyReq);</span>
&nbsp;
<span class="cstat-no" title="statement not covered">    proxyReq.on('response', <span
        class="fstat-no" title="function not covered">fu</span>nction(proxyRes) {</span>
<span class="cstat-no" title="statement not covered">      if(server) { <span class="cstat-no"
...
<span class="cstat-no" title="statement not covered">      proxyRes.on('end', <span class="fstat-no"
                                                                                    title="function not covered">fu</span>nction () {</span>
<span class="cstat-no"
      title="statement not covered">        server.emit('end', req, res, proxyRes);</span>
      });
&nbsp;
