    ...
    <div class='pad1'>
        <h1>
            <a href="../../../index.html">All files</a> / <a
                href="index.html">lib/http-proxy/passes</a> ws-incoming.js
        </h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre
        class="prettyprint lang-js">var http   = require('http'),
    https  = require('https'),
...
&nbsp;
<span class="cstat-no" title="statement not covered">    ['for', 'port', 'proto'].forEach(<span
        class="fstat-no" title="function not covered">fu</span>nction(header) {</span>
<span class="cstat-no"
      title="statement not covered">      req.headers['x-forwarded-' + header] =</span>
...
&nbsp;
    var createHttpHeader = <span class="cstat-no" title="statement not covered"><span
            class="fstat-no" title="function not covered">fu</span>nction(line, headers) {</span>
<span class="cstat-no" title="statement not covered">      return Object.keys(headers).reduce(<span
        class="fstat-no" title="function not covered">fu</span>nction (head, key) {</span>
...
<span class="cstat-no"
      title="statement not covered">          head.push(key + ': ' + value[i]);</span>
        }
<span class="cstat-no" title="statement not covered">        return head;</span>
      }, [line])
      .join('\r\n') + '\r\n\r\n';
...
&nbsp;
<span class="cstat-no" title="statement not covered">    if (head &amp;&amp; head.length) <span
        class="cstat-no" title="statement not covered">socket.unshift(head);</span></span>
&nbsp;
&nbsp;
...
&nbsp;
    // Error Handler
<span class="cstat-no"
      title="statement not covered">    proxyReq.on('error', onOutgoingError);</span>
<span class="cstat-no" title="statement not covered">    proxyReq.on('response', <span
        class="fstat-no" title="function not covered">fu</span>nction (res) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered">    proxyReq.on('upgrade', <span
        class="fstat-no" title="function not covered">fu</span>nction(proxyRes, proxySocket, proxyHead) {</span>
<span class="cstat-no"
      title="statement not covered">      proxySocket.on('error', onOutgoingError);</span>
&nbsp;
      // Allow us to listen when the websocket has completed
<span class="cstat-no" title="statement not covered">      proxySocket.on('end', <span
...
<span class="cstat-no"
      title="statement not covered">      server.emit('proxySocket', proxySocket); </span> //DEPRECATED.
    });
&nbsp;
...
<span class="cstat-no"
      title="statement not covered">        server.emit('error', err, req, socket);</span>
      }
...
<div class='footer quiet pad2 space-top1 center small'>
    Code coverage
    generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Apr 19 2018
    20:20:29 GMT-0400 (EDT)
</div>
</div>
