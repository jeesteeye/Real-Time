    ...
    <div class='pad1'>
        <h1>
            <a href="../../../index.html">All files</a> / <a
                href="index.html">lib/http-proxy/passes</a> web-incoming.js
        </h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered">        proxyRes.on('end', <span
        class="fstat-no" title="function not covered">fu</span>nction () {</span>
<span class="cstat-no" title="statement not covered">          if (server) <span class="cstat-no"
...
<span class="cstat-no" title="statement not covered">        if (!options.selfHandleResponse) <span
        class="cstat-no" title="statement not covered">proxyRes.pipe(res);</span></span>
      } else {
<span class="cstat-no" title="statement not covered">        if (server) <span class="cstat-no"
                                                                               title="statement not covered">server.emit('end', req, res, proxyRes);</span></span>
      }
