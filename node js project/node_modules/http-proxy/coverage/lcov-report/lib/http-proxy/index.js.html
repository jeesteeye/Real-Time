...
<div class='wrapper'>
    <div class='pad1'>
        <h1>
            <a href="../../index.html">All files</a> / <a href="index.html">lib/http-proxy</a>
            index.js
        </h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre
        class="prettyprint lang-js">var httpProxy = module.exports,
...
<span class="cstat-no" title="statement not covered">    return <span class="fstat-no"
      ...
      var passes = <span class="cstat-no" title="statement not covered">(type === 'ws') ? this.wsPasses : this.webPasses,</span>
          args = <span class="cstat-no"
                       title="statement not covered">[].slice.call(arguments),</span>
          cntr = <span class="cstat-no" title="statement not covered">args.length - 1,</span>
          head, cbl;
&nbsp;
      /* optional args parse begin */
<span class="cstat-no"
      title="statement not covered">      if(typeof args[cntr] === 'function') {</span>
...
<span class="cstat-no" title="statement not covered">      if(</span>
        ...
        //Copy global options
<span class="cstat-no"
      title="statement not covered">        requestOptions = extend({}, options);</span>
        //Overwrite with request options
<span class="cstat-no"
      title="statement not covered">        extend(requestOptions, args[cntr]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered">        cntr--;</span>
      }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered">      ['target', 'forward'].forEach(<span
        class="fstat-no" title="function not covered">fu</span>nction(e) {</span>
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">      for(var i=0; i &lt; passes.length; i++) {</span>
        /**
...
&nbsp;
<span class="cstat-no" title="statement not covered">  this.webPasses = Object.keys(web).map(<span
...
&nbsp;
<span class="cstat-no" title="statement not covered">  this.wsPasses = Object.keys(ws).map(<span
        class="fstat-no" title="function not covered">fu</span>nction(pass) {</span>
...
ProxyServer.prototype.onError = <span class="fstat-no" title="function not covered">fu</span>nction (err) {
  ...
  //
<span class="cstat-no"
      title="statement not covered">  if(this.listeners('error').length === 1) {</span>
...
<span class="cstat-no" title="statement not covered">    this._server.on('upgrade', <span
        class="fstat-no" title="function not covered">fu</span>nction(req, socket, head) { <span
...
<span class="cstat-no" title="statement not covered">    if(v.name === passName) <span
        class="cstat-no" title="statement not covered">i = idx;</span></span>
  })
&nbsp;
