...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre
        class="prettyprint lang-js">var common   = exports,
    url      = require('url'),
...
<span class="cstat-no"
      title="statement not covered">  outgoing.headers = extend({}, req.headers);</span>
&nbsp;
<span class="cstat-no" title="statement not covered">  if (options.headers){</span>
<span class="cstat-no"
      title="statement not covered">    extend(outgoing.headers, options.headers);</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">  outgoing.agent = options.agent || false;</span>
<span class="cstat-no"
      title="statement not covered">  outgoing.localAddress = options.localAddress;</span>
&nbsp;
  //
...
<span class="cstat-no"
      title="statement not covered">    outgoing.headers = outgoing.headers || {};</span>
...
&nbsp;
  ...
  var target = <span class="cstat-no"
                     title="statement not covered">options[forward || 'target'];</span>
